...
export const DEFAULT_AUTO_PRESS_SETTINGS: AutoPressSettings = {
  ...
  sources: [
    ...
    { id: "nwrss_art_perf", name: "뉴스와이어 공연예술",  boTable: "rss", sca: "", enabled: true,  fetchType: "rss", rssUrl: "https://api.newswire.co.kr/rss/industry/1201" },
    { id: "nwrss_art_vis",  name: "뉴스와이어 미술",      boTable: "rss", sca: "", enabled: true,  fetchType: "rss", rssUrl: "https://api.newswire.co.kr/rss/industry/1202" },
    { id: "nwrss_music",    name: "뉴스와이어 음악",      boTable: "rss", sca: "", enabled: true,  fetchType: "rss", rssUrl: "https://api.newswire.co.kr/rss/industry/1205" },
    { id: "nwrss_film",     name: "뉴스와이어 영화",      boTable: "rss", sca: "", enabled: true,  fetchType: "rss", rssUrl: "https://api.newswire.co.kr/rss/industry/1206" },
    { id: "nwrss_publish",  name: "뉴스와이어 출판",      boTable: "rss", sca: "", enabled: true,  fetchType: "rss", rssUrl: "https://api.newswire.co.kr/rss/industry/1208" },
    { id: "nwrss_heritage", name: "뉴스와이어 문화유산",   boTable: "rss", sca: "", enabled: true,  fetchType: "rss", rssUrl: "https://api.newswire.co.kr/rss/industry/1211" },
    { id: "nwrss_exhibit",  name: "뉴스와이어 전시",      boTable: "rss", sca: "", enabled: true,  fetchType: "rss", rssUrl: "https://api.newswire.co.kr/rss/theme/120" },
