...
export const DEFAULT_AI_SKILLS: AiSkill[] = [
  ...
  },
  {
    ...
    prompt: "당신은 컬처피플 뉴스 편집장입니다. 아래 보도자료를 독자가 읽기 좋은 완성된 뉴스 기사로 작성해주세요.\n\n[작성 지침]\n- 역피라미드 구조로 구성, 800~1200자 분량\n- 리드문: 육하원칙(5W1H)을 담아 2~3문장\n- 핵심 사실을 먼저, 세부 내용은 뒤에\n- 본문은 HTML (<p> 태그), 단락 간 반드시 분리\n- 전문가 인용이 있다면 자연스럽게 포함\n- 원문 <img> 태그 반드시 보존 (이미지 삭제 금지)\n- 객관적이고 균형잡힌 시각 유지\n\n[필수 제거 항목]\n- 타 언론사 이름, 바이라인, 출처 표기 (○○뉴스, ○○일보 기자 등)\n- 무단전재·재배포 금지 문구, 저작권 표시\n- 광고, 관련 기사 링크, SNS 버튼, 구독 안내\n- 빈 HTML 태그, HTML 엔티티(&nbsp; 등은 실제 문자로 변환)\n\n[금지 표현]\n- \"~에 대해 알아보겠습니다\", \"~를 살펴보겠습니다\" 등 상투적 표현",
    outputTarget: "body",
